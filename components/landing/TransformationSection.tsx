      ...
      <div className="max-w-7xl mx-auto text-center space-y-12 z-10 relative">
        <BlurFade delay={0.05} inView>
          <h2 className="text-5xl md:text-6xl font-bold font-mono tracking-tight text-foreground">
            <SparklesText>Forge Your Identity</SparklesText>: the "Atomic
            Habits" way
          </h2>
        </BlurFade>
        ...
        <BlurFade delay={0.1} inView>
          <p className="text-xl md:text-2xl font-mono text-muted-foreground leading-relaxed max-w-3xl mx-auto">
            ...
            , we've engineered a habit system that truly works. Forget
            willpower; our app focuses on making habits inevitable by reducing
            friction and building identity-based habits. We embrace the "Two-Day
            Rule"—never miss twice—to build resilience, and visualize your
            progress with intuitive "Today", "Yesterday", and "Pile" boxes,
            alongside robust streak calculations. This isn't just tracking; it's
            transforming.
          </p>
        </BlurFade>
        ...
        <BlurFade delay={0.2} inView>
          <p className="text-2xl md:text-3xl font-bold font-mono text-primary leading-relaxed max-w-4xl mx-auto">
            This isn't just a shift; it's a <b><u>revolution</u></b>. Prepare to be amazed
            at the identity you're about to forge.
          </p>
        </BlurFade>
        <PulseBadge
          link={"/me"}
