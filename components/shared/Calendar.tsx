...
function Calendar({
    ...
    <DayPicker
        ...
        classNames={{
            ...
            head_cell: "text-center text-[0.7rem] uppercase font-bold text-muted-foreground tracking-wider",
            row: "grid grid-cols-7 w-full mt-2",
            cell: "relative h-9 p-0 text-center text-sm focus-within:z-20 flex justify-center items-center",
